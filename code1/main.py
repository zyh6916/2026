...
def arg_parse():
    ...
    parser.add_argument('--weighted',type=bool,default=True)  # -----------------------权重
...
# python main.py --dataset CIFAR10 --epochs 100 --lr 0.001 --n_clients 8 --algorithm ckks --enc_batch_size 4096 --sim_len 200 --enc True --isSelection True --isSpars topk
